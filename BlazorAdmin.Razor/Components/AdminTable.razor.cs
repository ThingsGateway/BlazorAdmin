...
public partial class AdminTable<TItem> where TItem : class, new()
{
    ...
    [Parameter]
    public string? ExportButtonText { get; set; } = App.GetService<IStringLocalizerFactory>().Create(typeof(BlazorAdmin.Razor._Imports))["ExportButtonText"];
    ...
    [NotNull]
    private string? EmptyText { get; set; } = App.GetService<IStringLocalizerFactory>().Create(typeof(BlazorAdmin.Razor._Imports))["EmptyText"];

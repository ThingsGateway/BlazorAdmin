...
public class LocalizerUtil
{
    ...
    public static List<SelectedItem> GetBoolItems(Type modelType, string fieldName, bool canNull = false)
    {
        ...
        return App.GetService<ICacheService>().Cache.GetOrAdd(cacheKey, entry =>
        {
            ...
            {
                localizerAttr ??= App.GetService<IStringLocalizerFactory>().Create(typeof(NullableBoolItemsAttribute));

    ...
    public void ConfigBlazorServer(IServiceCollection services)
    {
        ...
        services.AddMonitorLogging(options =>
        {
            ...
            options.ConfigureLogger((logger, logContext, context) =>
            {
                ...
                var desc = App.GetService<IStringLocalizerFactory>().Create(controllerActionDescriptor.ControllerTypeInfo.AsType())[controllerActionDescriptor.MethodInfo.Name];
                //获取特性

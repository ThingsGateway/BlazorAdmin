...
public class SysResourceSeedData : ISqlSugarEntitySeedData<SysResource>
{
    ...
    public IEnumerable<SysResource> SeedData()
    {
        ...
        return SeedDataUtil.GetSeedDataByJson<SysResource>(SeedDataUtil.GetManifestResourceStream(assembly, "SeedData.Admin.seed_sys_resource.json")).Concat(SeedDataUtil.GetSeedDataByJson<SysResource>(SeedDataUtil.GetManifestResourceStream(assembly, "SeedData.Admin.seed_sys_resourcebutton.json"))).Concat(data1).Concat(data2);

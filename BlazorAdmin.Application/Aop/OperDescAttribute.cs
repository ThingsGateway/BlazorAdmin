...
public sealed class OperDescAttribute : MoAttribute
{
    ...
    private SysOperateLog GetOperLog(Type? localizerType, MethodContext context)
    {
        ...
        {
            Name = (localizerType == null ? App.GetService<IStringLocalizerFactory>().Create(typeof(OperDescAttribute)) : App.GetService<IStringLocalizerFactory>().Create(localizerType))![Description],

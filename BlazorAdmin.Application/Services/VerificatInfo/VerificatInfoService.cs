...
internal sealed class VerificatInfoService : BaseService<VerificatInfo>, IVerificatInfoService
{
    ...
    {
        //先从Cache拿
        var verificatInfo = App.GetService<ICacheService>().Cache.HashGetOne<VerificatInfo>(CacheConst.Cache_Token, id.ToString());
    ...
    {
        App.GetService<ICacheService>().Cache.HashAdd<VerificatInfo>(CacheConst.Cache_Token, verificatInfo.Id.ToString(), verificatInfo);
    }
    ...
    {
        App.GetService<ICacheService>().Cache.Remove(CacheConst.Cache_Token);
    }

    private static void RemoveCache(long id)
    {
        App.GetService<ICacheService>().Cache.HashDel<VerificatInfo>(CacheConst.Cache_Token, id.ToString());
    }
}

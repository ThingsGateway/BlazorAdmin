...
internal sealed class ApiPermissionService : IApiPermissionService
{
    ...
    public List<OpenApiPermissionTreeSelector> ApiPermissionTreeSelector()
    {
        ...
        var permissions = App.GetService<ICacheService>().Cache.Get<List<OpenApiPermissionTreeSelector>>(cacheKey);
        if (permissions == null)
        {
            permissions = new();
            ...
            App.GetService<ICacheService>().Cache.Set(cacheKey, permissions);
        }
        return permissions;
    }
    ...
    public List<PermissionTreeSelector> PermissionTreeSelector()
    {
        ...
        var permissions = App.GetService<ICacheService>().Cache.GetOrAdd(cacheKey, entry =>
        {
